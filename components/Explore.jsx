        ...
        <div className={style.ExploreArea}>
            ...
            <div className={style.Cards}>
                <div className={style.Card}>
                    <Image src={'/1.jpg'} width={328} height={250} alt="Data Innovation Partner"  className={style.Img}/>
                ...
                <div className={style.Card}>
                    <Image src={'/2.jpg'} width={328} height={250} alt="Data Innovation Partner"  className={style.Img}/>
                ...
                <div className={style.Card}>
                    <Image src={'/3.jpg'} width={328} height={250} alt="Data Innovation Partner"  className={style.Img}/>
